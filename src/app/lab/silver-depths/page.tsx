...
export default function SilverDepthsPage() {
  ...
  return (
    <main className="lsd-root lsd-mono min-h-screen p-2 sm:p-3">
      <style>{LSD_CSS}</style>
      ...
      <section className="mt-2 grid grid-cols-1 gap-2 lg:grid-cols-12">
        ...
        <div className="lsd-panel relative overflow-hidden lg:col-span-6">
        ...
        <div className="flex flex-col gap-2 lg:col-span-3">
          ...
          <div className="lsd-panel">
            ...
            <div className="px-2 pb-1">
              <svg viewBox="0 0 320 96" className="block w-full" role="img" aria-label="Tidal forecast sine chart">
                {/* phase dots */}
                {PHASE_CYCLE.map((p, i) => {
                  const x = 40 + i * 42;
                  return (
      ...
      <section className="mt-2 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-12">
        ...
        {/* ARCANE CORRELATIONS */}
        <div className="lsd-panel lg:col-span-4">
        ...
        {/* TIDE HARMONICS */}
        <div className="lsd-panel lg:col-span-2">
      ...
      <section className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
        {CHANNELS.map((c) => (
          <a key={c.n} href={c.href} className="lsd-panel lsd-card-link group relative block p-3">
      ...
      {/* ========================= MOON-SIGN BAND ========================= */}
      <section className="lsd-panel mt-2">
      ...
      <section className="mt-2 grid grid-cols-1 gap-2 lg:grid-cols-12">
        {/* DESTINY MATRIX */}
        <div className="lsd-panel lg:col-span-5">
        ...
        {/* ANALYSIS NOTES (FAQ) */}
        <div className="lsd-panel lg:col-span-7">
      ...
      {/* ============================== CTA PLATE ============================== */}
      <section className="lsd-panel relative mt-2 overflow-hidden px-4 py-6 text-center">
...
@media (prefers-reduced-motion: reduce){
  .lsd-rot-a,.lsd-rot-b,.lsd-rot-c,.lsd-pulse,.lsd-blink,.lsd-dash{ animation: none; }
}
`;
