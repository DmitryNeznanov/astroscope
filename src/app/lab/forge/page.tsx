...
const CSS = `
.lfg-root { background:#160509; color:#e0aebe; font-family:Georgia,'Times New Roman',serif; }
...
.lfg-sign {
  ...
  padding:12px 4px 10px; background:rgba(26,6,16,.6);
  border:1px solid rgba(226,92,128,.18);
  transition:border-color .3s, box-shadow .3s;
}
.lfg-sign:hover { border-color:rgba(255,92,140,.55); box-shadow:0 0 16px rgba(255,61,110,.25), inset 0 0 14px rgba(255,61,110,.12); }
.lfg-sign::after {
...
.lfg-tile:hover { border-color:rgba(255,92,140,.5); box-shadow:0 0 26px rgba(255,61,110,.28), inset 0 0 36px rgba(96,10,42,.4); }
details.lfg-faq { border:1px solid rgba(226,92,128,.2); background:rgba(26,6,16,.65); position:relative; }
...
.lfg-anim-scan { animation:lfg-scan ease-in-out infinite; }
...
@keyframes lfg-scan { 0%,100% { transform:translateX(0); } 50% { transform:translateX(26px); } }
...
function EssenceOrb({ e }: { e: Essence }) {
  return (
    <div className="flex flex-col items-center gap-1.5 py-4 px-1" style={{ border: "1px solid rgba(226,92,128,.16)", background: "rgba(22,5,13,.55)" }}>
    ...
    <main className="lfg-root min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:pt-20">
          <div className="relative">
            ...
            <h1 className="mt-7" style={{ fontSize: "clamp(38px, 5.6vw, 64px)", lineHeight: 1.06, color: "#ffeef2", fontWeight: 400 }}>
              We distill the sky
              <br />
              into{" "}
            ...
            {/* hero micro-readouts */}
            <div className="lfg-panel mt-11 grid grid-cols-3 divide-x" style={{ borderColor: "rgba(226,92,128,.2)" }}>
              {[
            ...
            <div className="lfg-ticks mt-1" style={{ opacity: .5 }} />
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          {ZODIAC.map((z, i) => (
            <a key={z.name} href="#" className="lfg-sign" style={{ textDecoration: "none" }}>
      ...
      {/* ============================================================ */}
      {/* 5 · SIX APPARATUS SECTIONS                                    */}
      {/* ============================================================ */}
      <section className="mx-auto max-w-6xl px-4 pb-18 sm:px-6" style={{ paddingBottom: 72 }}>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {SECTIONS.map((s, i) => (
            <article key={s.title} className="lfg-panel lfg-tile flex flex-col" style={{ marginTop: i % 3 === 1 ? 0 : i % 3 === 2 && i > 2 ? -8 : i % 3 === 0 && i > 0 ? 8 : 0 }}>
              <CornerTicks />
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div className="lfg-panel">
          ...
          <div className="grid grid-cols-1 gap-3 p-5 sm:grid-cols-3">
            {TODAY.map((t) => (
              <div key={t.label} className="relative px-4 py-3" style={{ border: "1px solid rgba(226,92,128,.18)", background: "rgba(22,5,13,.55)" }}>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6">
        ...
        <div className="flex flex-col gap-3">
          {FAQ.map((f) => (
            <details key={f.id} className="lfg-faq">
              <summary>
