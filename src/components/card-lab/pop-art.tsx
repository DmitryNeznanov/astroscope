/**
 * POP-ART — Major Arcana comic panel (default: The Hermit, IX)
 * Roy Lichtenstein comic panel. Bold black outlines, flat primary fills,
 * and Ben-Day dots (uniform SVG dot patterns) for ALL shading — sky, robe
 * shadow, mountain, skin. Yellow starburst with black outline rays behind
 * the lantern. Comic chrome: jagged caption box top-left with the roman
 * numeral, red name strip bottom. Palette strictly primary.
 *
 * Reusable via props: { number = 9, name = "THE HERMIT", variant = 0 }.
 * variant 0-7 selects one of 4 Lichtenstein palettes x normal/mirrored
 * composition; variant 0 + defaults renders the original Hermit card.
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ---- illustration (mirrored for variants 4-7) ---- */}
        <g transform={mirrorXf}>
          {/* ---- sky: base + Ben-Day dots ---- */}
          <rect x="4" y="4" width="192" height="258" fill={scheme.skyBase} />
          <rect x="4" y="4" width="192" height="258" fill="url(#cl-popart-dots-sky)" />

          {/* ---- lantern starburst: explosion + black outline rays ---- */}
          ...
          <g strokeLinejoin="round" strokeLinecap="round">
            ...
            <circle cx="146" cy="126" r="4" fill={scheme.accent} stroke="#0a0a0a" strokeWidth="2.5" />
            ...
            {/* lantern: accent fill, black outline, star inside */}
            <g>
              <path
