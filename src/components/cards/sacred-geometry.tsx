  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          pathLength={1}
          d="M150 118 L278.2 340 L21.8 340 Z"
          fill="none"
          stroke={GOLD}
          strokeWidth="1"
          className="cz-sg-draw"
        ...
        >
          ...
          <path
            pathLength={1}
            d="M136 156 Q134 128 150 120 Q166 128 164 156"
            className="cz-sg-draw"
            style={{ animationDelay: "1.05s" }}
          />
          ...
          <path
            pathLength={1}
            d="M141 152 Q150 158 159 152"
            strokeWidth="0.7"
            opacity="0.75"
            className="cz-sg-draw"
            style={{ animationDelay: "1.15s" }}
          />
          {/* left robe line: shoulder to hem */}
          <path
            pathLength={1}
            d="M136 156 Q128 172 126 196 L118 340"
            className="cz-sg-draw"
            style={{ animationDelay: "1.2s" }}
          />
          {/* right robe line: shoulder to hem */}
          <path
            pathLength={1}
            d="M164 156 Q172 172 174 196 L182 340"
            className="cz-sg-draw"
          ...
          <path
            pathLength={1}
            d="M208 128 L218 138 L218 152 L208 162 L198 152 L198 138 Z"
            strokeWidth="0.9"
            className="cz-sg-draw"
        ...
        <g className="cz-sg-lantern">
          <circle
            ...
            cy="145"
            r="26"
            fill="url(#cz-sg-lantern-glow)"
            className="cz-sg-glow"
          />
        ...
        {/* ===== double gold frame ===== */}
        <g fill="none" stroke={GOLD} className="cz-sg-appear" style={{ animationDelay: "0s" }}>
          <rect x="10" y="10" width="280" height="430" strokeWidth="1" />
          <rect x="15" y="15" width="270" height="420" strokeWidth="0.5" opacity="0.8" />
        </g>
